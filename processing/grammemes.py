...
VOICES = (
    ...
    'pass',
    # страдательный залог (только у причастий: разрушаемый, разрушенный)
    'med',
    # медиальный, или средний залог (глагольные формы на -ся: разрушился и т.п.)
)
...
GRAMM_CATEGORIES = (
    ...
    ASPECTS, TRANSITIVITIES, VOICES, MOODS_AND_FORMS, TENSES, PERSONS,
    ANTHROPONYMS,
    OTHER
)
GRAMMS = []
